...
import '../widget/navigation/custom_route.dart';
...
///选择相册
// Future<List<AssetEntity>> pickImages({maxImages = 9}) async {
//   var list = await AssetPicker.pickAssets(context, maxAssets: maxImages);
//   list = list ?? [];
//   flog(list);
