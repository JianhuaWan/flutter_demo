...
import 'package:flutter_app/page/home/house_brand_page.dart';
import 'package:flutter_app/page/home/ranking_page.dart';
import 'package:flutter_app/page/home/house_bamboo_page.dart';
import 'package:flutter_app/page/home/house_sale_page.dart';
...
import '../page/home/house_data_page.dart';
                ...
                onTap: () {
                  switch (i) {
                    case 0:
                      ...
                      break;
                    case 1:
                      jumpPage(HouseBambooPage());
                      break;
                    case 2:
                      jumpPage(HouseBrandPage());
                      break;
                    case 3:
                      jumpPage(HouseLoanPage());
                      break;
                    default:
                      jumpPage(HelpFindPage());
                      // showToast('开发中');
                      break;
                  }
                },
            ...
            return Expanded(
              child: WidgetTap(
                ...
                onTap: () {
                  switch (i) {
                    case 0:
                      jumpPage(RankingPage());
                      break;
                    case 1:
                      jumpPage(HouseSalePage());
                      break;
                    case 2:
                      jumpPage(ClinchDealPage());
                      break;
                    case 3:
                      jumpPage(HouseDataPage(isZige: true));
                      break;
                    default:
                      jumpPage(HouseLoanPage());
                      break;
...
class InformationWidget extends StatelessWidget {
  final Map? data;
  const InformationWidget({Key? key, this.data}) : super(key: key);
...
class circulateWidget extends StatefulWidget {
  final Map data;
  const circulateWidget(this.data, {Key? key}) : super(key: key);

  @override
  _circulateWidgetState createState() => _circulateWidgetState();
}

class _circulateWidgetState extends State<circulateWidget> with TickerProviderStateMixin, AutomaticKeepAliveClientMixin {
  var pageIndex = 1;
...
class HouseItem extends StatelessWidget {
  ...
  final int? index;
  const HouseItem({Key? key, this.i, this.data, this.isNoShowTherOther =
