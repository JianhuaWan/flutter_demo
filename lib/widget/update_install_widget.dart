...
class UpdateInstallWidget extends StatefulWidget {
  final String content;
  final String url;
  final String banben;
  final String pgkVer;

  const UpdateInstallWidget(this.content, this.url, this.banben, this.pgkVer,
      {Key? key})
      : super(key: key);

  @override
  _UpdateInstallWidgetState createState() => _UpdateInstallWidgetState();
}

class _UpdateInstallWidgetState extends State<UpdateInstallWidget> {
