...
class XiaoshoubangPage extends StatefulWidget {
  @override
  _XiaoshoubangPageState createState() => _XiaoshoubangPageState();
}

class _XiaoshoubangPageState extends State<XiaoshoubangPage> {
  @override
  void initState() {
    this.initData();
    super.initState();
  ...
  Widget build(BuildContext context) {
    return ScaffoldWidget(
      appBar: buildTitle(context, title: '销售榜', color: Colors.white),
