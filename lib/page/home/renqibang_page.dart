...
class RenqibangPage extends StatefulWidget {
  @override
  _RenqibangPageState createState() => _RenqibangPageState();
}

class _RenqibangPageState extends State<RenqibangPage> {
  @override
  void initState() {
    this.initData();
    super.initState();
  ...
  Widget build(BuildContext context) {
    return ScaffoldWidget(
      appBar: buildTitle(context, title: '人气榜', color: Colors.white),
