...
class HouseBayAreaPage extends StatefulWidget {
  @override
  _HouseBayAreaPageState createState() => _HouseBayAreaPageState();
}

class _HouseBayAreaPageState extends State<HouseBayAreaPage> {
  @override
  void initState() {
    this.initData();
    super.initState();
