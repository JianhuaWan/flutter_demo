...
class HouseBrandPage extends StatefulWidget {
  @override
  _HouseBrandPageState createState() => _HouseBrandPageState();
}

class _HouseBrandPageState extends State<HouseBrandPage> {
  @override
  void initState() {
    this.initData();
    super.initState();
