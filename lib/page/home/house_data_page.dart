...
class HouseDataPage extends StatefulWidget {
  final bool isZige;

  const HouseDataPage({Key? key, this.isZige = false}) : super(key: key);
  @override
  _HouseDataPageState createState() => _HouseDataPageState();
}

class _HouseDataPageState extends State<HouseDataPage> {
  var cityJson = [];
  var cityMap;
  var data;
