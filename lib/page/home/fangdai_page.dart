...
class FangdaiPage extends StatefulWidget {
  @override
  _FangdaiPageState createState() => _FangdaiPageState();
}

class _FangdaiPageState extends State<FangdaiPage> with NoSlidingReturn, TickerProviderStateMixin {
