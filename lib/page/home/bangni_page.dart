...
import 'package:kqsc/widget/city_picker.dart';
import 'package:kqsc/widget/date_picker.dart';
...
class BangniPage extends StatefulWidget {
  @override
  _BangniPageState createState() => _BangniPageState();
}

class _BangniPageState extends State<BangniPage> with NoSlidingReturn, TickerProviderStateMixin {
            ...
            switch (tabCon.index) {
              ...
              case 2:
                if (fangwei == null) {
                  ...
                  jumpPage(SousuoPage(data: {'fangwei': fangwei}));
                }
                break;
            }
          },
