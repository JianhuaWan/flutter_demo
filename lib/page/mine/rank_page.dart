...
import 'package:flutter_app/page/mine/rank_item_page.dart';
...
class _RankPageState extends State<RankPage> with NoSlidingReturn {
  @override
    ...
    return ScaffoldWidget(
      ...
      body: TabWidget(
        ...
        tabPage: List.generate(3, (i) {
          return RankItemPage(userLevel: '${i + 1}');
        }),
      ),
    );
  }
