...
class RankItemPage extends StatefulWidget {
  final String? userLevel;

  const RankItemPage({Key? key, this.userLevel}) : super(key: key);
  @override
  _RankItemPageState createState() => _RankItemPageState();
}

class _RankItemPageState extends State<RankItemPage> with AutomaticKeepAliveClientMixin {
  @override
  void initState() {
    this.initData();
    super.initState();
