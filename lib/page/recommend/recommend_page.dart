...
import '../mine/customer_page.dart';

class RecommendPage extends StatefulWidget {
  final bool isHome;
  final Map? data;

  const RecommendPage({Key? key, this.isHome = true, this.data}) : super(key:
  key);
  @override
          ...
          return MyListView(
            ...
            item: (i) {
              return WidgetTap(
                ...
                child: Row(
                  children: [
                    Expanded(child: HouseItem(i: i, data: list[i])),
                    Padding(
